...
<head>
    ...
    <title>Login Siswa - SMP Negeri 1 Solor Barat</title>
...
<body class="font-sans text-gray-900 dark:text-gray-100 antialiased min-h-screen flex items-center justify-center">
    ...
    <div
        ...
        <div class="text-center mb-8">
            <a href="/" class="block">
                {{-- Mengurangi ukuran logo agar tidak terlalu besar --}}
            ...
            <h1 class="text-3xl font-extrabold text-gray-800 dark:text-white mb-2">Login Siswa</h1>
            <p class="text-gray-600 dark:text-gray-400 text-md">Akses portal siswa Anda</p>
        </div>
        ...
        <form method="POST" action="{{ route('student.login.submit') }}">
            ...
            <div class="mb-5">
                <label for="nisn"
                    class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">NISN</label>
                <input type="text" name="nisn" id="nisn"
                    ...
                    placeholder="Masukkan NISN Anda" required autofocus autocomplete="username">
            </div>
            ...
            <div class="flex items-center justify-between mb-6">
                ...
                @if (Route::has('student.password.request'))
                    <a href="{{ route('student.password.request') }}" class="text-sm text-primary hover:underline dark:text-primary-lighter">Lupa Password?</a>
                @endif
                --}}
            </div>
        ...
        <div class="mt-8 text-center text-gray-600 dark:text-gray-400 text-sm">
            ...
            {{-- Uncomment if you have a student registration route --}}
            {{-- <a href="{{ route('student.register') }}" class="text-primary hover:underline">Daftar Sekarang</a> --}}
        </div>
    </div>
</body>
